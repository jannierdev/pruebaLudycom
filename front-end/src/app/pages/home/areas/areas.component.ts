...
import { columnasAreas, fieldForm } from './dataColumns';
...
export class AreasComponent {
  ...
  public dataColumns: Array<Column> = columnasAreas;
  ...
  reloadData(data: any) {
    if (this.edit)
      this._areasSerices.actualizarArea(data).
        subscribe({
          next: (response) => {
            this.loading = false;
      ...
      this._areasSerices.crearArea(data).
        subscribe({
          next: (response) => {
            this.loading = false;
            this.modalService.dismissAll();
